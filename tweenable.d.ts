...
import type { Data, Easing, EasingFunction, EasingObject, Filter, FinishFunction, FulfillmentHandler, PromisedData, RejectionHandler, RenderFunction, ScheduleFunction, StartFunction, TweenRawState, TweenState, TweenableConfig } from './types.js';
/**
 ...
 * @ignore
 */
export declare const tweenProps: <T extends TweenRawState>(
/**
 ...
 * returned directly.
 */
export declare const composeEasingObject: (fromTweenParams: TweenState, easing?: Easing, 
/**
 * Reused composedEasing object (mutated internally)
 */
composedEasing?: EasingObject | EasingFunction) => EasingObject | EasingFunction;
export declare class Tweenable {
     ...
     */
    fn: ScheduleFunction) => ScheduleFunction;
    /**
